...
export const SpinTrack = [
    {id: 'PegasusSpinTrack', name: "PegasusSpinTrack", attack: 1, defense: 0, stamina: 2},
    {id: 'LeoneSpinTrack', name: "LeoneSpinTrack", attack: 1, defense: 1, stamina: 3},
...
export const Tip = [
    {id: 'PegasusTip', name: "PegasusTip", attack: 3, defense: 1, stamina: 2},
    {id: 'LeoneTip', name: "LeoneTip", attack: 1, defense: 2, stamina: 1},
